...
if __name__ == '__main__':
    ...
    gold_amrs = "amr_2-four_translations/AMR/" + file_to_translate + ".txt"
    ...
    translator.save_translation("translations/" + file_to_translate + "_nmt.txt")
    translation_file = "translations/" + file_to_translate + "_nmt.txt"

    # parse translated file to AMR graphs save it to AMRgraphs folder
    sentences = read_file(translation_file)
    graphs = sent_to_graph(sentences, path_to_model="/content/Cross-Lingual-AMR-Parsing/model_parse_t5-v0_1_0", device="cuda") #TODO REMOVE CPU
