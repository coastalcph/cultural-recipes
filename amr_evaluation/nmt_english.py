...
class Translator(object):
    ...
    def __init__(self, model_name='opus-mt', device='cuda'):
    ...
    def load_sentences(self, to_translate_path, gold_path="None"):
        ...
        ##
        print(f'to translate path: {to_translate_path}')
        f = open(to_translate_path, 'r', encoding='utf-8')
        lines = f.readlines()
        print(f'expected lines: {len(lines)}')
        ##
        ...
        with open(self.to_translate_path, mode="r", encoding="utf-8") as fr:
            ...
            ##
            print(len(self.sentences_to_translate))
